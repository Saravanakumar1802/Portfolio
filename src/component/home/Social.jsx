...
const Social = () => {
  return (
    <div className="home_social">
      <a href="https://www.instagram.com/sk._.logan/" className="home_social-icon" target='_blank' >
        <i className="uil uil-instagram insta icon_size"></i>
      </a>

      <a href="https://github.com/Saravanakumar1802" className="home_social-icon" target='_blank' >
